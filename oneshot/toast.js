...
function showToastMessage(message, icon, iconFill, systemName, persist) {
    if (typeof notificationConfig === 'undefined' || notificationConfig === null) {
        notificationConfig = { all: true, screenPosition: 'bottomLeft' };
    }
    if (typeof notificationConfig.system === 'undefined' || notificationConfig.system === null) {
        notificationConfig.system = { all: true };
    }
