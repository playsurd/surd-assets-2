...
/* 			self.wait(33).then(function() {
	...
	module.prototype.getAdTagUrl = function(variant, priceMode, waterfallID) {
		...
		myAdTagUrl =
			"https://blocked.invalid/gampad/ads?gdpr=[gdpr]&npa=[npa]&gdfp_req=1&env=vp&output=xml_vast4&overlay=0&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
...
fg_api.prototype.videoadsModule = function() {
	...
	module.prototype.getAdTagUrl = function() {
		...
		// @see https://support.google.com/dfp_premium/answer/1068325?hl=de
		myadTagUrl =
			"https://blocked.invalid/gampad/ads?npa=1&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
