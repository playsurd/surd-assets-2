...
function renderSounds(filter = '') {
    ...
    finalSound.forEach(sound => {
        ...
        button.onclick = () => {
            ...
            const audio = new Audio("https://cdn.jsdelivr.net/gh/playsurd/surd-assets-2@main/soundboard/"+sound.mp3);
            audio.play();
...
function rightClickPanel(event, button, sound) {
    ...
    download.onclick = () => {
        ...
        link.href = 'https://cdn.jsdelivr.net/gh/playsurd/surd-assets-2@main/soundboard/'+sound.mp3;
