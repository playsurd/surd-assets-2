    ...
    function (t, e, o) {
      ...
      function j(t) {
        ...
        t: for (const r in e) {
          ...
          switch (r) {
            ...
            case "rgba": {
              const [, , , t, e, s, c] = o(n);
              if (t > 255 || e > 255 || s > 255 || c < 0 || c > 1 || !i(c))
                break t;
            ...
            case "hexa": {
              ...
              return (
                ...
                { values: [...C(e), o], a: o, type: r }
              );
            }
            case "hsla": {
              const [, , , t, e, s, c] = o(n);
              if (t > 360 || e > 100 || s > 100 || c < 0 || c > 1 || !i(c))
                break t;
        ...
        const e = {
            ...
            _tapmove(t) {
              ...
              ("h" !== r &&
                (i.style.left = "calc("
                  ...
                  .concat(i.offsetWidth / 2, "px)")),
                "v" !== r &&
                  (i.style.top = "calc("
                    .concat((l / c.height) * 100, "% - ")
                    .concat(i.offsetHeight / 2, "px)")),
            ...
            update(t = 0, o = 0) {
              ...
              ("h" === e.options.lock && (o = t),
                e._tapmove({ clientX: n + i * t, clientY: r + s * o }));
            },
            destroy() {
      ...
      /*! NanoPop 1.3.0 MIT | https://github.com/Simonwep/nanopop */ let F =
        (() => {
          class t {
            ...
            update(t = this.o, e = !1) {
              ...
              const p = n.getBoundingClientRect(),
                ...
                d = {
                  vm: -u.width / 2 + (p.left + p.width / 2),
                  vs: p.left,
                  ve: p.left + p.width - u.width,
                  hs: p.bottom - p.height,
          ...
          return (
            (t.version = "1.3.0"),
            (t.defaultVariantFlipOrder = {
              start: "sme",
              middle: "mse",
              end: "ems",
            }),
            (t.defaultPositionFlipOrder = {
              top: "tbrl",
              right: "rltb",
              bottom: "btrl",
              left: "lrbt",
      ...
      class N {
        constructor(t) {
          ...
          (["nano", "monolith"].includes(n) && !r && (t.sliders = "h"),
          ...
          ((this._nanopop = new F(u, h, { margin: s })),
            ...
            const {
              ...
              l = u(
                '\n      <div :ref="root" class="pickr">\n\n        '
                  ...
                  .concat(
                    c(Object.keys(e.interaction).length),
        ...
        setColor(t, e = !1) {
          ...
          if (o) {
            ...
            if (i && !i.hidden)
              for (const t of r)
                t.classList[t === i ? "add" : "remove"]("active");
